...
const About = () => {
  ...
  return (
    <section id="about" className="relative min-h-screen overflow-hidden bg-transparent text-white">
      ...
      <div className="relative z-10 mx-auto max-w-[1200px] px-6 py-16 sm:px-10 lg:px-24">
        <div className="grid items-center gap-10 lg:grid-cols-[0.95fr_1.05fr]">
          ...
          >
            ...
            <div className="max-w-xl space-y-4">
              <h1 className="text-5xl font-black tracking-tighter text-transparent sm:text-6xl md:text-7xl lg:text-7xl bg-gradient-to-r from-[#EAB308] via-[#FACC15] to-white bg-clip-text">
                <span className="block">PRIYANSHU</span>
                <span className="block">DHASMANA</span>
              </h1>
              <p className="max-w-xl text-xl leading-9 text-slate-300 sm:text-2xl">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
              <motion.a
                href="/gallery.html"
                whileHover={{ y: -2 }}
                className="relative inline-flex overflow-hidden rounded-full bg-[#EAB308] px-7 py-3 text-sm font-semibold text-slate-950 shadow-[0_18px_60px_rgba(234,179,8,0.2)] button-shimmer"
              >
              ...
              <motion.a
                href="#contact"
                whileHover={{ y: -2 }}
                className="inline-flex items-center justify-center rounded-full border border-[#EAB308] bg-transparent px-7 py-3 text-sm font-semibold text-white transition duration-300 hover:bg-[#EAB308]/10"
              >
            ...
            <div className="mt-8 grid gap-4 md:grid-cols-2">
              <motion.div
                ...
                className="relative overflow-hidden rounded-[1.75rem] border border-white/10 bg-white/5 p-5 backdrop-blur-md transition"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-white/10 via-transparent to-transparent opacity-60" />
                <div className="relative z-10 flex h-11 w-11 items-center justify-center rounded-2xl bg-white/10 text-[#FACC15] shadow-[0_12px_40px_rgba(250,204,21,0.12)]">
                  <Code2 size={20} />
                </div>
                <h3 className="relative z-10 mt-4 text-sm font-semibold text-white">Clean. Scalable. Reliable.</h3>
                <p className="relative z-10 mt-3 text-xs leading-5 text-slate-300">
              ...
              >
                ...
                <h3 className="relative z-10 mt-4 text-sm font-semibold text-white">Great UX. Real Impact.</h3>
                <p className="relative z-10 mt-3 text-xs leading-5 text-slate-300">
          ...
          >
            <motion.div
              ...
              className="group relative isolate h-[520px] w-full overflow-hidden rounded-[2.75rem] border border-[#1b1f26]/70 bg-white/5 shadow-[0_40px_120px_rgba(0,0,0,0.35)] backdrop-blur-md"
            >
              <div className="absolute inset-0 rounded-[2.75rem] border border-[rgba(255,255,255,0.12)] bg-[linear-gradient(135deg,rgba(255,255,255,0.08),transparent_30%)]" />
              <div className="absolute inset-2 rounded-[2.5rem] border border-[#EAB308]/20 pointer-events-none" />
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(234,179,8,0.12),transparent_50%)] opacity-50" />
              <div className="absolute inset-0 futuristic-grid opacity-35" />
              <div className="absolute inset-0 wireframe-overlay opacity-20 mix-blend-screen" />

              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.9, delay: 0.25, ease: 'easeOut' }}
                className="absolute left-5 top-28 w-40 rounded-[1.75rem] border border-white/10 bg-[#05080f]/85 p-3 text-[10px] text-slate-200 shadow-[0_20px_60px_rgba(0,0,0,0.25)] backdrop-blur-md"
              >
              ...
              <motion.div
                ...
                className="absolute right-5 top-24 w-36 rounded-[1.75rem] border border-white/10 bg-[#05080f]/85 p-3 text-[10px] text-slate-200 shadow-[0_20px_60px_rgba(0,0,0,0.25)] backdrop-blur-md"
              >
              ...
              <div className="absolute right-6 top-6 flex items-center gap-2 rounded-full border border-white/10 bg-[#02070f]/85 px-3 py-1.5 text-xs text-slate-100 backdrop-blur-md">
              ...
              <div className="absolute inset-5 overflow-hidden rounded-[2rem] border border-white/10 bg-[#060812]/95 shadow-[inset_0_0_45px_rgba(0,0,0,0.35)]">
                ...
                <div className="absolute inset-x-0 bottom-0 h-32 bg-[radial-gradient(circle_at_center,rgba(255,204,77,0.18),transparent_80%)]" />
                <img
                  src={profileImage}
                  alt="Priyanshu Dhasmana"
                  className="absolute inset-0 h-full w-full object-cover object-center filter contrast-[1.05] brightness-[0.92] saturate-[1.1]"
                />
